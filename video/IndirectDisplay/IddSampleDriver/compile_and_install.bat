...
:compile
echo.
echo 編譯 setupapi_install_simple.cpp...
cl.exe /nologo /O2 /W3 setupapi_install_simple.cpp setupapi.lib newdev.lib /link /out:install_driver.exe
...
cl.exe /nologo /O2 /W3 setupapi_install_simple.cpp setupapi.lib newdev.lib /link /out:install_driver.exe 2>nul
